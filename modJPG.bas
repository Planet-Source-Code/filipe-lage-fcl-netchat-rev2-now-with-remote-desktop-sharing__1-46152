...
'              IJL11.DLL (Intel)
'
'       FCL:   Changed to IJL15.DLL since it's the latest and more stable version of this DLL
'              The date of this DLL is 8/Fev/2003 - version 1.51.12.44
'
...
Public Function InstalledOK() As Boolean
On Error Resume Next
Dim NN As Long
Dim jc As JPEG_CORE_PROPERTIES_VB
NN = -1
NN = ijlInit(jc)
InstalledOK = NN <> -1
End Function
